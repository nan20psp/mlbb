...
load_dotenv()
BOT_TOKEN = os.getenv("BOT_TOKEN", "7927660379:AAEsm1s4sdi60OozbA-QiJDEJJvw5d0a9_M")
ADMIN_ID = int(os.getenv("ADMIN_ID", "5821905026"))

# Render á€•á€±á€«á€ºá€™á€¾á€¬ file path á€€á€­á€¯ adjust á€œá€¯á€•á€ºá€•á€«
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    keyboard = [[
        InlineKeyboardButton("ðŸ“‹ á€¡á€€á€±á€¬á€„á€·á€ºá€–á€½á€„á€·á€ºá€›á€”á€º", callback_data="register")
    ], [InlineKeyboardButton("ðŸ’µ á€˜á€±á€œá€„á€ºá€·á€€á€¼á€Šá€·á€ºá€›á€”á€º", callback_data="balance")],
                [InlineKeyboardButton("ðŸ’° á€˜á€±á€œá€„á€ºá€·á€–á€¼á€Šá€·á€ºá€›á€”á€º", callback_data="topup")],
                [InlineKeyboardButton("ðŸ›’ á€¡á€­á€¯á€„á€ºá€á€®á€šá€°á€›á€”á€º", callback_data="buy")],
                [InlineKeyboardButton("â„¹ï¸ á€¡á€€á€°á€¡á€Šá€®", callback_data="help")]]
    if update.message:
        await update.message.reply_text(
            f"ðŸ‘‹ á€€á€¼á€­á€¯á€†á€­á€¯á€•á€«á€á€šá€º {user.first_name}! á€€á€»á€±á€¸á€‡á€°á€¸á€•á€¼á€¯áá€¡á€±á€¬á€€á€ºá€•á€«á€™á€¾á€›á€½á€±á€¸á€á€»á€šá€ºá€•á€«!",
...
async def callback_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data == "register":
        if uid in db["users"] and db["users"][uid].get("approved", False):
            keyboard = [[
                InlineKeyboardButton("ðŸ  á€™á€°á€œá€…á€¬á€™á€»á€€á€ºá€”á€¾á€¬á€žá€­á€¯á€·", callback_data="start")
            ]]
            await query.edit_message_text(
                "âœ… á€¡á€€á€±á€¬á€„á€·á€ºá€–á€½á€„á€·á€ºá€•á€¼á€®á€¸á€–á€¼á€…á€ºá€•á€«á€žá€Šá€ºá‹",
                reply_markup=InlineKeyboardMarkup(keyboard))
            return
            ...
            await query.edit_message_text(
                "â³ á€¡á€€á€±á€¬á€„á€·á€ºá€–á€½á€„á€·á€ºá€á€±á€¬á€„á€ºá€¸á€á€¶á€á€»á€€á€ºá€€á€­á€¯ á€…á€±á€¬á€„á€·á€ºá€†á€­á€¯á€„á€ºá€¸á€”á€±á€•á€«á€žá€Šá€ºá‹ Admin á€™á€¾ á€¡á€á€Šá€ºá€•á€¼á€¯á€•á€±á€¸á€™á€Šá€ºá€–á€¼á€…á€ºá€•á€«á€žá€Šá€ºá‹",
                reply_markup=InlineKeyboardMarkup(keyboard))
            return
        ...
        await context.bot.send_message(
            chat_id=ADMIN_ID,
            text=f"ðŸ“¥ á€¡á€€á€±á€¬á€„á€·á€ºá€–á€½á€„á€·á€ºá€á€±á€¬á€„á€ºá€¸á€á€¶á€á€»á€€á€ºá€¡á€žá€…á€º:\n"
            f"ðŸ†” á€žá€¯á€¶á€¸á€…á€½á€²á€žá€° ID: {uid}\n"
        ...
        await query.edit_message_text(
            "ðŸ“ á€¡á€€á€±á€¬á€„á€·á€ºá€–á€½á€„á€·á€ºá€á€±á€¬á€„á€ºá€¸á€á€¶á€á€»á€€á€ºá€€á€­á€¯ Admin á€‘á€¶á€•á€­á€¯á€·á€•á€¼á€®á€¸á€•á€«á€•á€¼á€®á‹ á€¡á€á€Šá€ºá€•á€¼á€¯á€á€¶á€›á€•á€«á€€ á€žá€á€„á€ºá€¸á€•á€­á€¯á€·á€•á€±á€¸á€•á€«á€™á€Šá€ºá‹",
            reply_markup=InlineKeyboardMarkup(keyboard))
        ...
        if not is_user_approved(uid):
            ...
            await query.edit_message_text(
                "âš ï¸ á€žá€„á€·á€ºá€¡á€€á€±á€¬á€„á€·á€ºá€€á€­á€¯ Admin á€™á€¾ á€¡á€á€Šá€ºá€•á€¼á€¯á€›á€•á€«á€™á€Šá€ºá‹",
                reply_markup=InlineKeyboardMarkup(keyboard))
            return
        ...
        keyboard.append(
            [InlineKeyboardButton("ðŸ  á€™á€°á€œá€…á€¬á€™á€»á€€á€ºá€”á€¾á€¬á€žá€­á€¯á€·", callback_data="start")])
        await query.edit_message_text(
            f"ðŸ’µ á€˜á€±á€œá€„á€ºá€·á€œá€€á€ºá€€á€»á€”á€º: {user['balance']} MMK",
            reply_markup=InlineKeyboardMarkup(keyboard))
        ...
        await query.edit_message_text(
            "ðŸ’° á€˜á€±á€œá€„á€ºá€·á€–á€¼á€Šá€·á€ºá€›á€”á€º á€„á€½á€±á€œá€½á€¾á€²á€”á€Šá€ºá€¸á€œá€™á€ºá€¸á€›á€½á€±á€¸á€á€»á€šá€ºá€•á€«:",
            reply_markup=InlineKeyboardMarkup(keyboard))
        ...
        ], [InlineKeyboardButton("ðŸ  á€™á€°á€œá€…á€¬á€™á€»á€€á€ºá€”á€¾á€¬á€žá€­á€¯á€·", callback_data="topup")]]

        await query.edit_message_text(
            f"ðŸ’° {payment_method} á€˜á€±á€œá€„á€ºá€·á€–á€¼á€Šá€·á€ºá€›á€”á€º:\n\n"
            f"ðŸ“± á€–á€¯á€”á€ºá€¸á€”á€¶á€•á€«á€á€º: {payment_info['phone']}\n"
            f"ðŸ‘¤ á€¡á€™á€Šá€º: {payment_info['name']}\n\n"
            f"ðŸ“‹ á€–á€¯á€”á€ºá€¸á€”á€¶á€•á€«á€á€ºá€€á€­á€¯ á€€á€°á€¸á€šá€°á€›á€”á€º á€¡á€±á€¬á€€á€ºá€•á€«á€á€œá€¯á€á€ºá€€á€­á€¯á€”á€¾á€­á€•á€ºá€•á€«:\n\n"
            f"ðŸ’µ á€„á€½á€±á€œá€½á€¾á€²á€•á€¼á€®á€¸á€”á€±á€¬á€€á€º á€¡á€±á€¬á€€á€ºá€•á€«á€¡á€á€»á€€á€ºá€™á€»á€¬á€¸á€•á€­á€¯á€·á€•á€±á€¸á€•á€«:\n"
            f"â€¢ á€„á€½á€±á€œá€½á€¾á€²á€žá€° ID (á€˜á€±á€œá€„á€ºá€·á€–á€¼á€Šá€·á€ºá€›á€”á€º)\n"
            f"â€¢ á€„á€½á€±á€œá€½á€¾á€²á€žá€Šá€·á€ºá€•á€™á€¬á€\n"
            f"á€€á€»á€±á€¸á€‡á€°á€¸á€•á€¼á€¯áá€¡á€á€­á€¡á€€á€»á€•á€­á€¯á€·á€•á€±á€¸á€•á€«á‹\n\n"
            f"âš ï¸ á€žá€á€­á€•á€¼á€¯á€›á€”á€º: á€„á€½á€±á€œá€½á€¾á€²á€žá€° ID á€™á€¾á€¬á€¸á€šá€½á€„á€ºá€¸á€•á€«á€€ á€„á€½á€±á€™á€›á€›á€¾á€­á€”á€­á€¯á€„á€ºá€•á€«\n\n"
            f"ðŸ“¸ á€„á€½á€±á€œá€½á€¾á€²á€•á€¼á€®á€¸á€žá€Šá€·á€ºá€“á€¬á€á€ºá€•á€¯á€¶ á€•á€­á€¯á€·á€•á€±á€¸á€•á€«\n"
        ...
        await context.bot.send_message(chat_id=query.from_user.id,
                                       text=phone_number)
        await query.answer(
            f"ðŸ“‹ {phone_number} á€€á€°á€¸á€šá€°á€•á€¼á€®á€¸á€•á€«á€•á€¼á€®! á€€á€»á€±á€¸á€‡á€°á€¸á€•á€¼á€¯áá€„á€½á€±á€œá€½á€¾á€²á€•á€¼á€®á€¸á€“á€¬á€á€ºá€•á€¯á€¶á€•á€­á€¯á€·á€•á€±á€¸á€•á€«!",
            show_alert=True)
        ...
        await query.edit_message_text(
            ...
            "ðŸ“‹ á€œá€™á€ºá€¸á€Šá€½á€¾á€”á€ºá€á€»á€€á€ºá€™á€»á€¬á€¸:\n"
            "â€¢ Admin á€™á€¾ á€¡á€á€Šá€ºá€•á€¼á€¯á€•á€¼á€®á€¸á€™á€¾á€žá€¬ á€¡á€­á€¯á€„á€ºá€á€®á€á€šá€ºá€šá€°á€”á€­á€¯á€„á€ºá€™á€Šá€º\n"
            "â€¢ á€á€šá€ºá€šá€°á€•á€¼á€®á€¸á€”á€±á€¬á€€á€º á€€á€¯á€’á€ºá€™á€»á€¬á€¸á€›á€›á€¾á€­á€™á€Šá€º\n"
            "â€¢ á€„á€½á€±á€œá€½á€¾á€²á€žá€° ID á€–á€¼á€„á€·á€º á€¡á€­á€¯á€„á€ºá€á€®á€á€šá€ºá€šá€°á€”á€­á€¯á€„á€ºá€žá€Šá€º\n"
            "â€¢ á€˜á€±á€œá€„á€ºá€·á€œá€€á€ºá€€á€»á€”á€ºá€–á€¼á€„á€·á€ºá€œá€Šá€ºá€¸ á€á€šá€ºá€šá€°á€”á€­á€¯á€„á€ºá€žá€Šá€º",
            reply_markup=InlineKeyboardMarkup(keyboard))
        ...
        if not available_games:
            ...
            await query.edit_message_text(
                "âš ï¸ á€œá€€á€ºá€›á€¾á€­á€™á€¾á€¬á€›á€”á€­á€¯á€„á€ºá€žá€±á€¬á€¡á€­á€¯á€„á€ºá€á€®á€™á€›á€¾á€­á€•á€«á‹",
                reply_markup=InlineKeyboardMarkup(keyboard))
            return
        ...
        keyboard.append(
            [InlineKeyboardButton("ðŸ  á€™á€°á€œá€…á€¬á€™á€»á€€á€ºá€”á€¾á€¬á€žá€­á€¯á€·", callback_data="start")])
        await query.edit_message_text(
            "ðŸŽ® á€‚á€­á€™á€ºá€¸á€›á€½á€±á€¸á€á€»á€šá€ºá€›á€”á€º:",
            reply_markup=InlineKeyboardMarkup(keyboard))
        ...
        if not amounts:
            keyboard = [[
                InlineKeyboardButton("ðŸ  á€™á€°á€œá€…á€¬á€™á€»á€€á€ºá€”á€¾á€¬á€žá€­á€¯á€·", callback_data="buy")
            ]]
            await query.edit_message_text(
                "âš ï¸ á€¤á€‚á€­á€™á€ºá€¸á€¡á€á€½á€€á€ºá€›á€”á€­á€¯á€„á€ºá€žá€±á€¬á€¡á€­á€¯á€„á€ºá€á€®á€™á€›á€¾á€­á€•á€«á‹",
                reply_markup=InlineKeyboardMarkup(keyboard))
            return
        ...
        for amount in amounts:
            ...
            keyboard.append([
                InlineKeyboardButton(
                    f"ðŸ’³ {amount} {unit} - {price} MMK ({codes_count})",
        ...
        keyboard.append(
            [InlineKeyboardButton("ðŸ  á€™á€°á€œá€…á€¬á€™á€»á€€á€ºá€”á€¾á€¬á€žá€­á€¯á€·", callback_data="buy")])
        await query.edit_message_text(
            f"ðŸŽ® {game_name}\nðŸ’³ á€•á€™á€¬á€á€›á€½á€±á€¸á€á€»á€šá€ºá€›á€”á€º:",
            reply_markup=InlineKeyboardMarkup(keyboard))
        ...
        if amount not in db["stock"].get(
            ...
            keyboard = [[
                InlineKeyboardButton("ðŸ  á€™á€°á€œá€…á€¬á€™á€»á€€á€ºá€”á€¾á€¬á€žá€­á€¯á€·",
                                     callback_data=f"select_{game_type}")
            ]]
            await query.edit_message_text(
                "âš ï¸ á€¤á€•á€™á€¬á€á€¡á€á€½á€€á€ºá€›á€”á€­á€¯á€„á€ºá€žá€±á€¬á€¡á€­á€¯á€„á€ºá€á€®á€™á€›á€¾á€­á€•á€«á‹",
                reply_markup=InlineKeyboardMarkup(keyboard))
            return
        ...
        await query.edit_message_text(
            f"ðŸŽ® {game_name}\n"
            f"ðŸ’³ {amount} {unit}\n"
            f"ðŸ’µ á€ˆá€±á€¸á€”á€¾á€¯á€”á€ºá€¸: {price} MMK/á€¡á€­á€¯á€„á€ºá€á€®\n"
            f"ðŸ’° á€˜á€±á€œá€„á€ºá€·á€œá€€á€ºá€€á€»á€”á€º: {user['balance']} MMK\n"
            f"ðŸ“Š á€›á€”á€­á€¯á€„á€ºá€žá€±á€¬á€¡á€›á€±á€¡á€á€½á€€á€º: {max_quantity} á€á€¯\n\n"
            f"ðŸ“ á€á€šá€ºá€šá€°á€™á€Šá€·á€ºá€¡á€›á€±á€¡á€á€½á€€á€ºá€›á€­á€¯á€€á€ºá€‘á€Šá€·á€ºá€•á€« (1 to {max_quantity}):",
            reply_markup=InlineKeyboardMarkup(keyboard))
        ...
        if user["balance"] >= total_price:
            keyboard.append([
                InlineKeyboardButton(
                    f"ðŸ’µ á€˜á€±á€œá€„á€ºá€·á€–á€¼á€„á€·á€ºá€á€šá€ºá€šá€°á€›á€”á€º ({total_price} MMK)",
        ...
        keyboard.append([
            InlineKeyboardButton(
                "ðŸ“„ á€„á€½á€±á€œá€½á€¾á€²á€žá€°IDá€–á€¼á€„á€·á€ºá€á€šá€ºá€šá€°á€›á€”á€º",
        ...
        await query.edit_message_text(
            f"ðŸŽ® {game_name}\n"
            f"ðŸ’³ {amount} {unit} x {quantity}\n"
            f"ðŸ’µ á€…á€¯á€…á€¯á€•á€±á€«á€„á€ºá€¸á€ˆá€±á€¸á€”á€¾á€¯á€”á€ºá€¸: {total_price} MMK\n"
            f"ðŸ’° á€˜á€±á€œá€„á€ºá€·á€œá€€á€ºá€€á€»á€”á€º: {user['balance']} MMK\n\n"
            f"ðŸ’° á€„á€½á€±á€•á€±á€¸á€á€»á€±á€™á€¾á€¯á€”á€Šá€ºá€¸á€œá€™á€ºá€¸á€›á€½á€±á€¸á€á€»á€šá€ºá€›á€”á€º:",
            reply_markup=InlineKeyboardMarkup(keyboard))
        ...
        if user["balance"] < total_price:
            keyboard = [[
                InlineKeyboardButton("ðŸ’° á€˜á€±á€œá€„á€ºá€·á€–á€¼á€Šá€·á€ºá€›á€”á€º", callback_data="topup")
                        ...
                        [
                            InlineKeyboardButton(
                                "ðŸ  á€™á€°á€œá€…á€¬á€™á€»á€€á€ºá€”á€¾á€¬á€žá€­á€¯á€·",
                                callback_data=
        ...
        if len(db["stock"][game_type][amount]) < quantity:
            ...
            await query.edit_message_text(
                "âš ï¸ á€œá€€á€ºá€›á€¾á€­á€™á€¾á€¬á€›á€”á€­á€¯á€„á€ºá€žá€±á€¬á€¡á€­á€¯á€„á€ºá€á€®á€™á€œá€¯á€¶á€œá€±á€¬á€€á€ºá€•á€«á‹",
                reply_markup=InlineKeyboardMarkup(keyboard))
            return
        ...
        await query.edit_message_text(
            f"âœ… á€¡á€­á€¯á€„á€ºá€á€®á€á€šá€ºá€šá€°á€™á€¾á€¯á€¡á€±á€¬á€„á€ºá€™á€¼á€„á€ºá€•á€«á€žá€Šá€º!\n\n"
            f"ðŸŽ® {game_name}\n"
            f"ðŸ’³ {amount} {unit} x {quantity}\n"
            f"ðŸ’µ á€…á€¯á€…á€¯á€•á€±á€«á€„á€ºá€¸á€ˆá€±á€¸á€”á€¾á€¯á€”á€ºá€¸: {total_price} MMK\n\n"
            f"ðŸ”‘ á€¡á€­á€¯á€„á€ºá€á€®á€€á€¯á€’á€ºá€™á€»á€¬á€¸:\n{codes_text}\n\n"
            f"ðŸ’° á€˜á€±á€œá€„á€ºá€·á€œá€€á€ºá€€á€»á€”á€º: {user['balance']} MMK",
            reply_markup=InlineKeyboardMarkup(keyboard))
        ...
        await query.edit_message_text(
            "ðŸ“„ á€„á€½á€±á€œá€½á€¾á€²á€žá€°IDá€–á€¼á€„á€·á€ºá€á€šá€ºá€šá€°á€›á€”á€º:\n\n"
            "1ï¸âƒ£ á€„á€½á€±á€œá€½á€¾á€²á€•á€¼á€®á€¸á€žá€Šá€·á€ºá€“á€¬á€á€ºá€•á€¯á€¶á€•á€­á€¯á€·á€•á€±á€¸á€•á€«\n"
            "2ï¸âƒ£ á€„á€½á€±á€œá€½á€¾á€²á€žá€° ID (á€˜á€±á€œá€„á€ºá€·á€–á€¼á€Šá€·á€ºá€›á€”á€º) á€›á€­á€¯á€€á€ºá€‘á€Šá€·á€ºá€•á€±á€¸á€•á€«\n\n"
            "âš ï¸ á€žá€á€­á€•á€¼á€¯á€›á€”á€º: á€„á€½á€±á€œá€½á€¾á€²á€žá€° ID á€™á€¾á€¬á€¸á€šá€½á€„á€ºá€¸á€•á€«á€€ á€¡á€­á€¯á€„á€ºá€á€®á€™á€›á€”á€­á€¯á€„á€ºá€•á€«",
            reply_markup=InlineKeyboardMarkup(keyboard))
    ...
    # Admin approval handlers
        ...
        if uid != ADMIN_ID:
            await query.edit_message_text(
                "âš ï¸ Admin á€™á€Ÿá€¯á€á€ºá€•á€«á€€ á€¤á€œá€¯á€•á€ºá€†á€±á€¬á€„á€ºá€á€»á€€á€ºá€€á€­á€¯á€žá€¯á€¶á€¸á€á€½á€„á€·á€ºá€™á€›á€¾á€­á€•á€«á‹")
            return
        ...
        await query.edit_message_text("ðŸ’¬ á€žá€¯á€¶á€¸á€…á€½á€²á€žá€°á€‘á€¶á€™á€€á€ºá€†á€±á€·á€•á€­á€¯á€·á€›á€”á€º á€…á€¬á€›á€­á€¯á€€á€ºá€‘á€Šá€·á€ºá€•á€«:")
        ...
        if receipt_id not in db["receipts"]:
            await query.edit_message_text("âš ï¸ á€„á€½á€±á€œá€½á€¾á€²á€žá€°IDá€™á€›á€¾á€­á€•á€«á‹")
            return
        ...
        if action == "approve":
            ...
            await context.bot.send_message(
                user_id,
                f"âœ… á€˜á€±á€œá€„á€ºá€·á€–á€¼á€Šá€·á€ºá€™á€¾á€¯á€¡á€±á€¬á€„á€ºá€™á€¼á€„á€ºá€•á€«á€žá€Šá€º!\nðŸ’° á€–á€¼á€Šá€·á€ºá€žá€½á€„á€ºá€¸á€„á€½á€±: {amount} MMK\nðŸ’µ á€˜á€±á€œá€„á€ºá€·á€œá€€á€ºá€€á€»á€”á€º: {user['balance']} MMK"
            )
            await query.edit_message_text(
            ...
            await context.bot.send_message(user_id,
                                           "âŒ á€˜á€±á€œá€„á€ºá€·á€–á€¼á€Šá€·á€ºá€á€±á€¬á€„á€ºá€¸á€á€¶á€á€»á€€á€ºá€•á€šá€ºá€–á€»á€€á€ºá€á€¶á€›á€•á€«á€žá€Šá€ºá‹")
            await query.edit_message_text(
                f"âŒ á€˜á€±á€œá€„á€ºá€·á€–á€¼á€Šá€·á€ºá€á€±á€¬á€„á€ºá€¸á€á€¶á€á€»á€€á€º {receipt_id} á€•á€šá€ºá€–á€»á€€á€ºá€•á€¼á€®á€¸á€•á€«á€•á€¼á€®")
        ...
        if action == "approve":
            ...
            await context.bot.send_message(
                user_id,
                "âœ… á€žá€„á€·á€ºá€¡á€€á€±á€¬á€„á€·á€ºá€¡á€á€Šá€ºá€•á€¼á€¯á€•á€¼á€®á€¸á€•á€«á€•á€¼á€®! á€šá€á€¯á€¡á€á€« bot á€€á€­á€¯á€¡á€žá€¯á€¶á€¸á€•á€¼á€¯á€”á€­á€¯á€„á€ºá€•á€«á€•á€¼á€®!"
            )
            await query.edit_message_text(
                f"âœ… á€žá€¯á€¶á€¸á€…á€½á€²á€žá€° {user_id} á á€¡á€€á€±á€¬á€„á€·á€ºá€–á€½á€„á€·á€ºá€á€±á€¬á€„á€ºá€¸á€á€¶á€á€»á€€á€ºá€¡á€á€Šá€ºá€•á€¼á€¯á€•á€¼á€®á€¸á€•á€«á€•á€¼á€®")
        else:
            del db["pending_registrations"][user_id]
            save_db(db)
            await context.bot.send_message(
                user_id, "âŒ á€žá€„á€·á€ºá€¡á€€á€±á€¬á€„á€·á€ºá€–á€½á€„á€·á€ºá€á€±á€¬á€„á€ºá€¸á€á€¶á€á€»á€€á€ºá€•á€šá€ºá€–á€»á€€á€ºá€á€¶á€›á€•á€«á€žá€Šá€ºá‹")
            await query.edit_message_text(
                f"âŒ á€žá€¯á€¶á€¸á€…á€½á€²á€žá€° {user_id} á á€¡á€€á€±á€¬á€„á€·á€ºá€–á€½á€„á€·á€ºá€á€±á€¬á€„á€ºá€¸á€á€¶á€á€»á€€á€ºá€•á€šá€ºá€–á€»á€€á€ºá€•á€¼á€®á€¸á€•á€«á€•á€¼á€®")
        ...
        if action == "approve":
            if len(db["stock"][game_type].get(amount, [])) < quantity:
                await query.edit_message_text("âš ï¸ á€œá€€á€ºá€›á€¾á€­á€™á€¾á€¬á€›á€”á€­á€¯á€„á€ºá€žá€±á€¬á€¡á€­á€¯á€„á€ºá€á€®á€™á€œá€¯á€¶á€œá€±á€¬á€€á€ºá€•á€«á‹")
                return
            ...
            codes_text = "\n".join([f"ðŸ”‘ {code}" for code in codes])
            await context.bot.send_message(
                user_id, f"âœ… á€„á€½á€±á€œá€½á€¾á€²á€žá€°IDá€–á€¼á€„á€·á€ºá€¡á€­á€¯á€„á€ºá€á€®á€á€šá€ºá€šá€°á€™á€¾á€¯á€¡á€±á€¬á€„á€ºá€™á€¼á€„á€ºá€•á€«á€žá€Šá€º!\n\n"
                f"ðŸŽ® {game_name}\n"
                f"ðŸ’³ {amount} {unit} x {quantity}\n\n"
                f"ðŸ”‘ á€¡á€­á€¯á€„á€ºá€á€®á€€á€¯á€’á€ºá€™á€»á€¬á€¸:\n{codes_text}")
            await query.edit_message_text(f"âœ… á€„á€½á€±á€œá€½á€¾á€²á€žá€°ID {receipt_id} á€¡á€á€Šá€ºá€•á€¼á€¯á€•á€¼á€®á€¸á€•á€«á€•á€¼á€®")
        else:
            receipt["status"] = "rejected"
            save_db(db)
            await context.bot.send_message(
                user_id, "âŒ á€žá€„á€·á€ºá€„á€½á€±á€œá€½á€¾á€²á€žá€°IDá€–á€¼á€„á€·á€ºá€¡á€­á€¯á€„á€ºá€á€®á€á€šá€ºá€šá€°á€™á€¾á€¯á€•á€šá€ºá€–á€»á€€á€ºá€á€¶á€›á€•á€«á€žá€Šá€ºá‹")
            await query.edit_message_text(f"âŒ á€„á€½á€±á€œá€½á€¾á€²á€žá€°ID {receipt_id} á€•á€šá€ºá€–á€»á€€á€ºá€•á€¼á€®á€¸á€•á€«á€•á€¼á€®")
    ...
    # Admin addstock interactive handlers
        ...
        unit = "Coin" if "MLBB" in game_type else "UC"
        await query.edit_message_text(
            f"ðŸŽ® {game_name} á€¡á€­á€¯á€„á€ºá€á€®á€‘á€Šá€·á€ºá€›á€”á€º:\n\n"
            f"ðŸ“ á€–á€±á€¬á€ºá€™á€á€º: <amount> <price> <code1> <code2> ...\n"
            f"á€¥á€•á€™á€¬: 1000 2500 CODE123 CODE456\n\n"
            f"ðŸ”¢ {unit} á€•á€™á€¬á€, á€ˆá€±á€¸á€”á€¾á€¯á€”á€ºá€¸, á€¡á€­á€¯á€„á€ºá€á€®á€€á€¯á€’á€ºá€™á€»á€¬á€¸á€›á€­á€¯á€€á€ºá€‘á€Šá€·á€ºá€•á€«:",
            reply_markup=InlineKeyboardMarkup(keyboard))
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if update.message.photo:
        ...
        if 'topup_method' in context.user_data:
            ...
            await update.message.reply_text(
                "ðŸ“„ á€„á€½á€±á€œá€½á€¾á€²á€“á€¬á€á€ºá€•á€¯á€¶á€œá€€á€ºá€á€¶á€›á€›á€¾á€­á€•á€«á€•á€¼á€®á‹ á€€á€»á€±á€¸á€‡á€°á€¸á€•á€¼á€¯áá€¡á€±á€¬á€€á€ºá€•á€«á€¡á€á€»á€€á€ºá€™á€»á€¬á€¸á€•á€­á€¯á€·á€•á€±á€¸á€•á€«:\n\n"
                "ðŸ“ á€–á€±á€¬á€ºá€™á€á€º: <á€„á€½á€±á€œá€½á€¾á€²á€žá€° ID (á€˜á€±á€œá€„á€ºá€·á€–á€¼á€Šá€·á€ºá€›á€”á€º)> <á€„á€½á€±á€œá€½á€¾á€²á€•á€™á€¬á€>\n"
                "á€¥á€•á€™á€¬: 123456 50000\n\n"
                "âš ï¸ á€žá€á€­á€•á€¼á€¯á€›á€”á€º: á€„á€½á€±á€œá€½á€¾á€²á€žá€° ID á€™á€¾á€¬á€¸á€šá€½á€„á€ºá€¸á€•á€«á€€ á€„á€½á€±á€™á€›á€›á€¾á€­á€”á€­á€¯á€„á€ºá€•á€«")
            return
        ...
        # Handle receipt purchase photos
            ...
            await update.message.reply_text(
                "ðŸ“„ á€„á€½á€±á€œá€½á€¾á€²á€“á€¬á€á€ºá€•á€¯á€¶á€œá€€á€ºá€á€¶á€›á€›á€¾á€­á€•á€«á€•á€¼á€®á‹ á€€á€»á€±á€¸á€‡á€°á€¸á€•á€¼á€¯á á€„á€½á€±á€œá€½á€¾á€²á€žá€° ID (á€˜á€±á€œá€„á€ºá€·á€–á€¼á€Šá€·á€ºá€›á€”á€º) á€›á€­á€¯á€€á€ºá€‘á€Šá€·á€ºá€•á€±á€¸á€•á€«:\n\n"
                "á€¥á€•á€™á€¬: 123456\n\n"
                "âš ï¸ á€žá€á€­á€•á€¼á€¯á€›á€”á€º: á€„á€½á€±á€œá€½á€¾á€²á€žá€° ID á€™á€¾á€¬á€¸á€šá€½á€„á€ºá€¸á€•á€«á€€ á€¡á€­á€¯á€„á€ºá€á€®á€™á€›á€”á€­á€¯á€„á€ºá€•á€«")
            return
    ...
    if update.message.text:
        ...
        if uid == ADMIN_ID and 'admin_messaging' in context.user_data:
            ...
            await context.bot.send_message(target_user,
                                           f"ðŸ“¨ Admin á€™á€¾ á€™á€€á€ºá€†á€±á€·:\n{text}")
            await update.message.reply_text(
                f"âœ… á€žá€¯á€¶á€¸á€…á€½á€²á€žá€° {target_user} á€‘á€¶ á€™á€€á€ºá€†á€±á€·á€•á€­á€¯á€·á€•á€¼á€®á€¸á€•á€«á€•á€¼á€®")
        ...
        if 'selecting_quantity' in context.user_data:
            try:
                ...
                if quantity < 1 or quantity > selection['max_quantity']:
                    await update.message.reply_text(
                        f"âš ï¸ á€¡á€›á€±á€¡á€á€½á€€á€ºá€žá€Šá€º 1 á€™á€¾ {selection['max_quantity']} á€¡á€á€½á€„á€ºá€¸á€›á€¾á€­á€›á€•á€«á€™á€Šá€º"
                    )
                    return
                ...
                if user["balance"] >= total_price:
                    ...
                    keyboard.append([
                        InlineKeyboardButton("ðŸ’° á€˜á€±á€œá€„á€ºá€·á€–á€¼á€Šá€·á€ºá€›á€”á€º",
                                             callback_data="topup")
                    ])
        ...
        if uid == ADMIN_ID and 'addstock_game' in context.user_data:
            try:
                ...
                await update.message.reply_text(
                    ...
                    f"ðŸ’µ á€ˆá€±á€¸á€”á€¾á€¯á€”á€ºá€¸: {price} MMK\n"
                    f"ðŸ“¦ á€¡á€­á€¯á€„á€ºá€á€®: {len(codes)} á€á€¯ á€‘á€Šá€·á€ºá€žá€½á€„á€ºá€¸á€•á€¼á€®á€¸á€•á€«á€•á€¼á€®")
                ...
                await update.message.reply_text("âš ï¸ á€–á€±á€¬á€ºá€™á€á€ºá€™á€¾á€¬á€¸á€šá€½á€„á€ºá€¸á€”á€±á€•á€«á€žá€Šá€ºá‹")
                return
        ...
        if context.user_data.get('topup_photo_sent'):
            try:
                ...
                if len(parts) != 2:
                    await update.message.reply_text(
                        "âš ï¸ á€–á€±á€¬á€ºá€™á€á€º: <á€„á€½á€±á€œá€½á€¾á€²á€žá€° ID> <á€„á€½á€±á€œá€½á€¾á€²á€•á€™á€¬á€>")
                    return
                ...
                if not validate_receipt_id(receipt_id):
                    await update.message.reply_text(
                        "âš ï¸ á€„á€½á€±á€œá€½á€¾á€²á€žá€° ID á€žá€Šá€º á…-á† á€œá€¯á€¶á€¸á€‚á€á€”á€ºá€¸á€–á€¼á€…á€ºá€›á€•á€«á€™á€Šá€º")
                    return

                if amount < 1000:
                    await update.message.reply_text(
                        "âš ï¸ á€„á€½á€±á€œá€½á€¾á€²á€•á€™á€¬á€á€žá€Šá€º 1000 MMK á€‘á€€á€ºá€™á€”á€Šá€ºá€¸á€›á€•á€«"
                    )
                    return
                ...
                keyboard = [[
                    ...
                    InlineKeyboardButton(
                        "ðŸ’¬ á€™á€€á€ºá€†á€±á€·á€•á€­á€¯á€·á€›á€”á€º",
                        callback_data=f"message_topup_{receipt_id}"),
                    InlineKeyboardButton(
                        "âŒ á€•á€šá€ºá€–á€»á€€á€ºá€›á€”á€º",
                ...
                await context.bot.send_message(
                    chat_id=ADMIN_ID,
                    text=f"ðŸ“¥ á€˜á€±á€œá€„á€ºá€·á€–á€¼á€Šá€·á€ºá€á€±á€¬á€„á€ºá€¸á€á€¶á€á€»á€€á€ºá€¡á€žá€…á€º:\n"
                    f"ðŸ†” á€žá€¯á€¶á€¸á€…á€½á€²á€žá€°: {uid}\n"
                    f"ðŸ’° á€”á€Šá€ºá€¸á€œá€™á€ºá€¸: {payment_method}\n"
                    f"ðŸ“„ á€„á€½á€±á€œá€½á€¾á€²á€žá€° ID: {receipt_id}\n"
                    f"ðŸ’µ á€•á€™á€¬á€: {amount} MMK",
                    reply_markup=InlineKeyboardMarkup(keyboard))
        ...
        if 'buying_game' in context.user_data and context.user_data.get(
            ...
            keyboard = [[
                ...
                InlineKeyboardButton("ðŸ’¬ á€™á€€á€ºá€†á€±á€·á€•á€­á€¯á€·á€›á€”á€º",
                                     callback_data=f"message_{text}"),
                InlineKeyboardButton("âŒ á€•á€šá€ºá€–á€»á€€á€ºá€›á€”á€º",
            ...
            await context.bot.send_message(
                chat_id=ADMIN_ID,
                text=f"ðŸ“¥ á€¡á€­á€¯á€„á€ºá€á€®á€á€šá€ºá€šá€°á€á€±á€¬á€„á€ºá€¸á€á€¶á€á€»á€€á€ºá€¡á€žá€…á€º:\n"
                f"ðŸ†” á€žá€¯á€¶á€¸á€…á€½á€²á€žá€°: {uid}\n"
                f"ðŸŽ® á€‚á€­á€™á€ºá€¸: {game_name}\n"
                f"ðŸ’³ {amount} {unit} x {quantity}\n"
                f"ðŸ“„ á€„á€½á€±á€œá€½á€¾á€²á€žá€° ID: {text}",
                reply_markup=InlineKeyboardMarkup(keyboard))
            await update.message.reply_text("â³ Admin á€‘á€¶á€á€±á€¬á€„á€ºá€¸á€á€¶á€á€»á€€á€ºá€•á€­á€¯á€·á€•á€¼á€®á€¸á€•á€«á€•á€¼á€®...")
...
async def setbalance(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        save_db(db)
        await update.message.reply_text(
            f"âœ… á€žá€¯á€¶á€¸á€…á€½á€²á€žá€° {uid} á á€˜á€±á€œá€„á€ºá€·á€œá€€á€ºá€€á€»á€”á€ºá€€á€­á€¯ {amount} MMK á€žá€á€ºá€™á€¾á€á€ºá€•á€¼á€®á€¸á€•á€«á€•á€¼á€®")
    except:
        await update.message.reply_text(
...
async def setprice(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        unit = "Coin" if "MLBB" in game_type else "UC"
        await update.message.reply_text(
            f"âœ… {game_name} {amount} {unit} á á€ˆá€±á€¸á€”á€¾á€¯á€”á€ºá€¸á€€á€­á€¯ {price} MMK á€žá€á€ºá€™á€¾á€á€ºá€•á€¼á€®á€¸á€•á€«á€•á€¼á€®"
        )
    except:
        await update.message.reply_text(
            "á€¡á€žá€¯á€¶á€¸á€•á€¼á€¯á€”á€Šá€ºá€¸: /setprice <MLBBbal/MLBBph/PUPG> <amount> <price>")
...
async def setpayment(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        if method not in ["Wave", "Kpay"]:
            await update.message.reply_text(
                "á€„á€½á€±á€œá€½á€¾á€²á€”á€Šá€ºá€¸á€œá€™á€ºá€¸: Wave á€žá€­á€¯á€·á€™á€Ÿá€¯á€á€º KPay")
            return

        db["payment"][method] = {"phone": phone, "name": name}
        save_db(db)
        await update.message.reply_text(
            f"âœ… {method} á€„á€½á€±á€œá€½á€¾á€²á€¡á€á€»á€€á€ºá€¡á€œá€€á€ºá€™á€»á€¬á€¸á€žá€á€ºá€™á€¾á€á€ºá€•á€¼á€®á€¸á€•á€«á€•á€¼á€®\nðŸ“± á€–á€¯á€”á€ºá€¸á€”á€¶á€•á€«á€á€º: {phone}\nðŸ‘¤ á€¡á€™á€Šá€º: {name}"
        )
    except:
        await update.message.reply_text(
...
async def viewhistory(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        if not user["history"]:
            await update.message.reply_text(
                f"á€žá€¯á€¶á€¸á€…á€½á€²á€žá€° {uid} á á€™á€¾á€á€ºá€á€™á€ºá€¸á€™á€›á€¾á€­á€•á€«á‹")
            return
        ...
        await update.message.reply_text(
            f"ðŸ“œ á€žá€¯á€¶á€¸á€…á€½á€²á€žá€° {uid} á á€™á€¾á€á€ºá€á€™á€ºá€¸:\n{history_text}")
    except:
...
/setbalance <user_id> <amount> - á€žá€¯á€¶á€¸á€…á€½á€²á€žá€°á€˜á€±á€œá€„á€ºá€·á€žá€á€ºá€™á€¾á€á€ºá€›á€”á€º
...
/setprice <MLBBbal/MLBBph/PUPG> <amount> <price> - á€ˆá€±á€¸á€”á€¾á€¯á€”á€ºá€¸á€žá€á€ºá€™á€¾á€á€ºá€›á€”á€º
/setpayment <Wave/Kpay> <phone> <name> - á€„á€½á€±á€œá€½á€¾á€²á€¡á€á€»á€€á€ºá€¡á€œá€€á€ºá€žá€á€ºá€™á€¾á€á€ºá€›á€”á€º
/viewhistory <user_id> - á€žá€¯á€¶á€¸á€…á€½á€²á€žá€°á€™á€¾á€á€ºá€á€™á€ºá€¸á€€á€¼á€Šá€·á€ºá€›á€”á€º
/admhelp - á€¤á€¡á€€á€°á€¡á€Šá€®á€…á€¬á€™á€»á€€á€ºá€”á€¾á€¬á€•á€¼á€›á€”á€º

ðŸ“Š á€…á€¬á€›á€„á€ºá€¸á€‡á€šá€¬á€¸:
ðŸŽ® MLBB Bal á€¡á€­á€¯á€„á€ºá€á€®: {mlbbbal_count}
ðŸŽ® MLBB PH á€¡á€­á€¯á€„á€ºá€á€®: {mlbbph_count}
ðŸŽ® PUPG á€¡á€­á€¯á€„á€ºá€á€®: {pupg_count}
ðŸ‘¥ á€žá€¯á€¶á€¸á€…á€½á€²á€žá€°: {len(db["users"])}
ðŸ“¦ á€…á€¯á€…á€¯á€•á€±á€«á€„á€ºá€¸á€¡á€™á€¾á€¬á€…á€¬: {total_orders}
ðŸ’µ á€žá€¯á€¶á€¸á€…á€½á€²á€žá€°á€˜á€±á€œá€„á€ºá€·á€…á€¯á€…á€¯á€•á€±á€«á€„á€ºá€¸: {total_user_balance:,} MMK
ðŸ’° á€…á€¯á€…á€¯á€•á€±á€«á€„á€ºá€¸á€›á€±á€¬á€„á€ºá€¸á€¡á€¬á€¸: {db.get('sales_total', 0):,} MMK
â³ á€…á€±á€¬á€„á€·á€ºá€†á€­á€¯á€„á€ºá€¸á€„á€½á€±á€œá€½á€¾á€²á€žá€°ID: {pending_receipts}
...
ðŸ”§ á€…á€®á€™á€¶á€á€”á€·á€ºá€á€½á€²á€™á€¾á€¯á€œá€™á€ºá€¸á€Šá€½á€¾á€”á€ºá€á€»á€€á€ºá€™á€»á€¬á€¸:
â€¢ á€žá€¯á€¶á€¸á€…á€½á€²á€žá€°á€¡á€€á€±á€¬á€„á€·á€ºá€™á€»á€¬á€¸á€€á€­á€¯ Admin á€™á€¾á€¡á€á€Šá€ºá€•á€¼á€¯á€•á€±á€¸á€›á€•á€«á€™á€Šá€º
â€¢ á€¡á€­á€¯á€„á€ºá€á€®á€•á€™á€¬á€á€™á€»á€¬á€¸á€€á€­á€¯á€‚á€›á€¯á€á€…á€­á€¯á€€á€ºá€‘á€Šá€·á€ºá€žá€½á€„á€ºá€¸á€•á€«
â€¢ Admin á€™á€¾á€žá€¯á€¶á€¸á€…á€½á€²á€žá€°á€™á€»á€¬á€¸á€‘á€¶á€™á€€á€ºá€†á€±á€·á€•á€­á€¯á€·á€”á€­á€¯á€„á€ºá€žá€Šá€º (ðŸ’¬ á€á€œá€¯á€á€º)
    """
...
def main():
    ...
    try:
        ...
        # Render á€•á€±á€«á€ºá€™á€¾á€¬ web server á€™á€œá€­á€¯á€¡á€•á€ºá€•á€« - polling á€€á€­á€¯á€•á€²á€žá€¯á€¶á€¸á€•á€«
